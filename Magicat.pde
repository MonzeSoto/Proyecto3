...
Wizad = new Cats("Wizad",210,8,9,12,0);
 ...
 //SOUND
/* robost = new SoundFile(this, "music.mp3");
robost.play();
robost.amp(0.4);*/
...
text(cat1.nombre,100,470);

}
else {

  fill(#FFFFFF);
  text(cat2.nombre,100,470);
